(function () {
    ...
    .service('FormUserAuthorizationService', ['$http', '$q', 'breeze', 'breezeservice',
        ...
        this.Search = function (predicate, page, pageSize, cancelExistingSearch) {
            ...
            var query = breeze.EntityQuery.from('FormUserAuthorizationApi/Search');
            if (predicate != null) {
        ...
        this.Get = function (id) {
            ...
            $http({
                method: 'Get',
                url: '/breeze/FormUserAuthorizationApi/Get/' + id,
        ...
        this.Create = function (item) {
            ...
            $http.post('/breeze/FormUserAuthorizationApi/Create', item)
        ...
        this.Delete = function (id) {
            ...
            $http.delete('/breeze/FormUserAuthorizationApi/Delete/' + id)
            .then(function (response) {
                deferred.resolve(response);
            }, function (response) {
                if (response.statusText.length > 0) {
