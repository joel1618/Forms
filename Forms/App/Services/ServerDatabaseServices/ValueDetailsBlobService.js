(function () {
    ...
    .service('ValueDetailsBlobService', ['$http', '$q', 'breeze', 'breezeservice',
        function ($http, $q, breeze, breezeservice) {
            ...
            this.Search = function (predicate, page, pageSize, cancelExistingSearch) {
                ...
                var query = breeze.EntityQuery.from('ValueDetailsBlobApi/Search');
                if (predicate != null) {
            ...
            this.Create = function (item) {
                var deferred = $q.defer();
                debugger;
                $http.post('/breeze/ValueDetailsBlobApi/Create', item)
